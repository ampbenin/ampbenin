/**
 * Dashboard IS — Formulaire de saisie financière institutionnelle
 * AMP BENIN
 */
...
export default function AddInstitutionFinanceForm({ onFinanceAdded }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Erreur finance IS :", err);
  ...
  return (
    <section className="add-institution-finance-form">
