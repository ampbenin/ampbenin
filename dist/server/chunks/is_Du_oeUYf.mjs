const IS_LIST = [
    ...
    {
      slug: 'sspbs',
      name: 'Section de Santé Publique et Bien-être Social (SSPBS-AMP)',
      description: 'Agit pour la santé communautaire et le bien-être social.',
      image: '/images/is/sspbs.jpg',
      missions: [
